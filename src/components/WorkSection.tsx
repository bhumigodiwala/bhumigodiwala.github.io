...
import { ChevronDown, ChevronUp, Github, ExternalLink, Sparkles, Layers, Cpu, Database, Check } from 'lucide-react';
...
export const WorkSection: React.FC = () => {
  // Accordion open state for the six projects
  ...
  return (
    <div id="work" className="border-t border-white/[0.08]">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
        {/* =========================================================================
            SECTION 1: WHAT I WORK ON
        ========================================================================= */}
        <div>
          <p className="font-mono text-xs uppercase text-slate-500 dark:text-slate-400 font-semibold tracking-wider">01 — Focus</p>
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div className="flex flex-col rounded-2xl border border-slate-200/90 dark:border-white/[0.08] bg-white dark:bg-white/[0.025] p-6 backdrop-blur-xl shadow-sm dark:shadow-none transition-colors">
              ...
              <div className="mt-4 flex-1 flex flex-col justify-end">
                {/* Embed the interactive Edge Parallelism Visualizer */}
        ...
        {/* =========================================================================
            SECTION 2: SELECTED WORK - SIX PROJECTS, OPENED UP
        ========================================================================= */}
        <div id="projects" className="mt-20 pt-16 border-t border-slate-200/90 dark:border-white/[0.08] scroll-mt-24 relative">
          <span id="portfolio" className="absolute -top-24" aria-hidden="true" />
          <span id="selected-work" className="absolute -top-24" aria-hidden="true" />
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              <p className="font-mono text-xs uppercase text-slate-500 dark:text-slate-400 font-semibold tracking-wider">02 — Portfolio</p>
              <h2 className="mt-2 font-display text-3xl font-medium text-slate-900 dark:text-slate-100 sm:text-4xl">
                Selected work
              </h2>
                ...
                >
                  ...
                  <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      {/* Metric Badges (outside inner card, matching template) */}
        ...
        {/* =========================================================================
            SECTION 3: TOOLS - WHAT I REACH FOR
        ========================================================================= */}
        <div id="skills" className="mt-20 pt-16 border-t border-slate-200/90 dark:border-white/[0.08] scroll-mt-20">
          <span id="tools" className="sr-only" />
          <p className="font-mono text-xs uppercase text-slate-500 dark:text-slate-400 font-semibold tracking-wider">03 — Stack</p>
          <h2 className="mt-2 font-display text-3xl font-medium text-slate-900 dark:text-slate-100 sm:text-4xl">
            Tools
          </h2>
